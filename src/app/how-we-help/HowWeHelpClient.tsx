...
export default function HowWeHelpClient() {
  return (
    <>
      ...
      {/* HOW WE HELP SECTION */}
      <section className="relative w-full h-screen bg-[#FFFEED] md:overflow-hidden">
        {/* Overlay Image */}
        <div className="absolute inset-0 w-full h-full z-10">
          <Image
            src="/BG_overlay.svg"
        ...
        >
          ...
          <motion.p
            ...
            custom={3}
          >
            We provide a dedicated, anonymous phone line that has one of our experienced 
            volunteers on the other end. Put simply, we will listen to what it is that is 
            troubling you. We’re here to help you get it off your chest.
          </motion.p>
          ...
          <motion.p
            ...
            custom={4}
          >
            We are not here to offer advice, but we collaborate with a number of 
            organisations that we may signpost you to, in order to make sure you are 
            not left without an option.
          </motion.p>
          ...
          <motion.p
            ...
            custom={5}
          >
            Whether you want to talk about personal or professional worries, it 
            doesn’t matter. Our volunteers have the personal and professional experience 
            to listen actively to what you have to say, and act accordingly.
          </motion.p>
