...
export default function ArticleContentClient({ article }: ArticleContentClientProps) {
      ...
      <section className="relative w-full h-135 2xl:h-250 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full -z-10">
          <Image
            ...
            fill
            priority
            className="object-cover object-center lg:object-[center_-150px]"
          />
  ...
  components={{
    ...
    ul: ({ children }) => (
      <ul className="list-disc ml-6 mb-4 text-[15px] sm:text-[15px] md:text-[15px]
                     lg:text-[15px] xl:text-[15px] 2xl:text-[27px]
                     font-light leading-relaxed tracking-[0.5px] text-justify">
        {children}
      </ul>
    ),
    ol: ({ children }) => (
      <ol className="list-decimal ml-6 mb-4 text-[15px] sm:text-[15px] md:text-[15px]
                     lg:text-[15px] xl:text-[15px] 2xl:text-[27px]
                     font-light leading-relaxed tracking-[0.5px] text-justify">
        {children}
      </ol>
    ...
    li: ({ children }) => (
      <li className="text-[15px] sm:text-[15px] md:text-[15px]
                     lg:text-[15px] xl:text-[15px] 2xl:text-[27px]
                     font-light leading-relaxed tracking-[0.5px]
                     text-justify ml-4">
        {children}
...
>
  {block.body}
              ...
              <p className="text-[15px] sm:text-[15px] md:text-[15px]
                            lg:text-[15px] xl:text-[15px] 2xl:text-[27px]
                            mb-[24px] font-light
                            leading-relaxed tracking-[0.5px] text-justify">
                No content found
              </p>
            )}
          </motion.div>
